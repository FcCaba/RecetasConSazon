...
$("#btnpbizcochodemandarinayalmendra").click(function () {
    agregar("#nombre", "#precio");
});
$("#btnBizcochosencillodemanzanaylimon").click(function () {
    agregar("#nombre2", "#precio2");
});
$("#btnPuerrosgratinadosconjamonyqueso").click(function () {
    agregar("#nombre3", "#precio3");
});
$("#btnTortilladepatatasvegana").click(function () {
    agregar("#nombre4", "#precio4");
});
$("#btnpizza").click(function () {
    agregar("#nombre5", "#precio5");
});
$("#btncalamaresalaandaluza").click(function () {
    agregar("#nombre6", "#precio6");
});
$("#btnSalmona").click(function () {
